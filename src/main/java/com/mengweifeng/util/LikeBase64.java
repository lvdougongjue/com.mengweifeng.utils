...
public class LikeBase64 {
	...
	// 64个字符
	private static final char[] CHARS = { 'L', 'B', '6', 'F', 'E', 'D', 'G', '4', 'I', 'J', 'K', 'A', 'k', '8', 'O', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', '1', 'g', 'Y', 'Z', 'a', 'b', 'c', 'd', 'e',
			'f', 'X', '9', 'i', 'j', 'M', 'l', 'm', 'n', 'o', 'p', 'q', 'r', 's', 't', 'u', 'v', 'w', 'x', 'y', 'z', '0', 'W', '2', '3', 'H', '5', 'C', '7', 'N', 'h', '-', '_' };

	// 64个字符的index map
	private static final int[] CHARS_MAP = new int[128];
	static {
		for (int i = 0; i < 64; CHARS_MAP[CHARS[i]] = i++)
			;
	}
